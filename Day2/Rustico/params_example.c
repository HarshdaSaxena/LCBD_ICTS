...
#Path of datax2: /home/harshda/Downloads/galaxy_DR12v5_CMASSLOWZTOT_North_t1.txt
#Path of randomsx2: /home/harshda/Downloads/random0_DR12v5_CMASSLOWZTOT_North_t1.txt
#Path of output: /home/harshda/LCBD/Day2
#Identifier of output: eBOSS_SGC_Om031_OL084
#Write header (yes/no): yes
#Write density (no/corrected/uncorrected): no

#FFT parameters
#Number of Grid Cells power (int): 8
#Type of mass assingment (NGC/CIC/TSC/PCS/P4S/P5S): CIC
#Type of Yamamoto (GridCenter/GridAverage): GridCenter
#Number of interlacing steps (int): 2
#Do Grid Correction? (yes/no): yes

#Cutsky parameters
#Redshift Range (double/double)x2: 0.4 0.6
#Omega_matter Omega_Lambda values (double/double): 0.3 0.7
#Area effective value in deg^2 (double)x2: 7341
